...
def non_max_suppression(classes_names, predictions_with_boxes, confidence_threshold, iou_threshold=0.4):
    """
    ...
    for i, image_pred in enumerate(predictions):
        ...
        for cls in unique_classes:
            # if(classes_names[cls]=='person' or classes_names[cls]=='car'):
